...
class StudentEditor extends DefaultTreeCellEditor {
    public StudentEditor(JTree tree, DefaultTreeCellRenderer renderer) {
        super(tree, renderer);
    }

    @Override
    public Component getTreeCellEditorComponent(JTree tree, Object value, boolean isSelected, boolean expanded, boolean leaf, int row) {
        if (leaf) return super.getTreeCellEditorComponent(tree, value, isSelected, expanded, leaf, row);
...
class Frame extends JFrame {
    ...
    private void setCountries() {
        ...
        countriesList.setCellRenderer((list, value, index, isSelected, cellHasFocus)-> {
            ...
            if (isSelected) {
                ...
                label.setText(value.getName() + " " + countries.get(value));
            }
            else {
    ...
    private void setTrips() {
        ...
        trips.add(new Trip(new Country("Greece"), "greece", 1000));
    ...
    private void setStudents() {
        ...
        renderer.setLeafIcon(new ImageIcon("flag_belarus.png"));
        ...
        tree.setCellEditor(new StudentEditor(tree, renderer));
        ...
        tree.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_INSERT) {
                    ...
                    if (selNode != null && selNode instanceof StudentNode) {
                        DefaultMutableTreeNode groupNode = (GroupNode) selNode.getParent();
                        DefaultMutableTreeNode yearNode = (YearNode) groupNode.getParent();

                        Student student = new Student((Integer) yearNode.getUserObject(), (Integer) groupNode.getUserObject(),"New Student");
                        DefaultMutableTreeNode newNode = new StudentNode(student);
                        model.insertNodeInto(newNode, groupNode, groupNode.getChildCount());
    ...
    private void updateStudents() {
        ...
        for (Student student : students) {
            ...
            if (curYear != student.getYear()) {
                ...
                curGroup = 0;
                yearNode = new YearNode(curYear);
                root.add(yearNode);
            }
            if (curGroup != student.getGroup()) {
                curGroup = student.getGroup();
                groupNode = new GroupNode(curGroup);
